...
public class GamePanel extends JPanel {
    ...
    // 생성자
    public GamePanel(JFrame superFrame, CardLayout cl, Main mainClass,String characterName) {
        this.superFrame = superFrame;
        this.cl = cl;
        this.mainClass = mainClass;
        this.hitSoundManager = new SoundManager("C:/Users/iseoy/Mulgoging/src/Sound/Ma Sfx Sys Enter 5 by Dneproman Id-334890.wav");
        arrowAngle = 0;
        new Timer(40, e -> updateGame()).start();

        arrow = new Arrow(210,500, "C:/Users/iseoy/Mulgoging/src/Image/arrow_1.png");

        sliderTimer = new Timer(1, new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                updateSliderPosition();
            }
        });
        directionTimer = new Timer(1, new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                updateDirectionSliderPosition();
            }
        });
        arrowAngleTimer = new Timer(1, new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                updateArrowAngle();
            }
    ...
    private void loadImages() {
        ImageIcon backgroundIcon = new ImageIcon("C:/Users/iseoy/Mulgoging/src/Image/물고깅배경.jpg");
        backgroundImage = backgroundIcon.getImage();


        ImageIcon powerBarIcon = new ImageIcon("C:/Users/iseoy/Mulgoging/src/Image/powerbar.png"); // 힘 조절 바 이미지 경로
        powerBarImage = powerBarIcon.getImage();

        ImageIcon directionIcon = new ImageIcon("C:/Users/iseoy/Mulgoging/src/Image/directionbar.png"); // 힘 조절 바 이미지 경로
        directionImage = directionIcon.getImage();

        ImageIcon sliderIcon = new ImageIcon("C:/Users/iseoy/Mulgoging/src/Image/barstick.png"); // 힘 조절 바 이미지 경로
    ...
    public void setCurrentCharacter(String characterName) {
        this.currentCharacter = new Character(characterName);
    }
    // 게임 리셋 (초기화)
    ...
    private void initializeFishes() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            String imagePath = "C:/Users/iseoy/Mulgoging/src/Image/fish.png"; // 올바른 이미지 경로
